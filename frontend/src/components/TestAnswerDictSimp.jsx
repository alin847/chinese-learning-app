...
import './TestAnswerDictSimp.css';

function TestAnswerDictSimp({ answerData, onNext }) {
    const correct = answerData.correct;
    const simplified = answerData.simplified;
    const answer = answerData.answer;
    const simplified_indices = answerData.simplified_indices;
    ...
    return (
        <div className="test-answer">
            ...
            <div className="test-answer-comment">
                <h3>Expected Answer: <ColorSentence sentence={simplified} greenIndices={simplified_indices} /></h3>
...
export default TestAnswerDictSimp;